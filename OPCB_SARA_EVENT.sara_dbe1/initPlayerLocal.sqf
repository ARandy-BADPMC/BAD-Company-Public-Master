...
[player, [7662.37,195.235,18],"USS Khe Sahn"] call BIS_fnc_addRespawnPosition;
...
switch (typeOf player) do { 
	case "rhsusf_airforce_jetpilot" : {
		...
		base_flag addAction ["Teleport to Stennis", {[player,[7142.17,296.141,18]] remoteExec ["setPosasl",2];}];
		nimitz_flag addAction ["Teleport to Wasp", {[player,[7686.3,183.379,18]] remoteExec ["setPosasl",2];}];
		}; 
