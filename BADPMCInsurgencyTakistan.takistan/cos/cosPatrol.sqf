...
{_group=_x;
_group setBehaviour "SAFE";_group setSpeedMode "LIMITED";
_EHkilledIdx=(leader _group)addEventHandler["FiredNear",{_this call breakPatrol_FN;}];
...
_wp1 setWaypointCompletionRadius 10;}forEach _grpArrayTwo+_grpArray;