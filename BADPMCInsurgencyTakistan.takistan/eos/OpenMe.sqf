...
[_markerArray,[paramsArray select 11,paramsArray select 12],[paramsArray select 13,paramsArray select 14,paramsArray select 15],[0,0],[0,0],[0,0],[0,0],[paramsArray select 10,2,paramsArray select 22,EAST,FALSE,FALSE]] call EOS_Spawn;
...
[_markerArray,[0,0],[paramsArray select 13,paramsArray select 14,paramsArray select 15],[1,0,50],[paramsArray select 16,paramsArray select 17],[paramsarray select 18,paramsArray select 19],[0,0],[paramsArray select 10,2,paramsArray select 23,EAST,FALSE,FALSE]] call EOS_Spawn;
