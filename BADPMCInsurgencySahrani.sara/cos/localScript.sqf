"COSTownLabel" addPublicVariableEventHandler{private["_GHint","_GHint1","_Hintg","_sizeX","_sizeY"];
...
"COSGlobalSideChat" addPublicVariableEventHandler{private["_GHint","_ghint1","_ghint2","_ghint3","_hintg"];
_hintg=(_this select 1);
_GHint=(_hintg select 0);
_ghint1=(_hintg select 1);
