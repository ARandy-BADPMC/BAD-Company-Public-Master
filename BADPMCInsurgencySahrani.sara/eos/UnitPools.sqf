...
// RHS AFRF 
	...
	_uavPool=	[];
	_stPool=	["RHS_AGS30_TriPod_VDV","RHS_NSV_TriPod_VDV","rhs_KORD_VDV"];
	_shipPool=	[];
	_diverPool=	[];
	_crewPool=	["rhs_vdv_des_driver_armored"];
	_heliCrew=	["rhs_pilot_combat_heli"];
	};
	
// RHS Tanoa Liberation Force 	
	if (_faction==6) then {
	_InfPool=	["rhsgref_tla_specialist_at","rhsgref_tla_squadleader","rhsgref_tla_grenadier","rhsgref_tla_rifleman","rhsgref_tla_rifleman_akms","rhsgref_tla_rifleman_l1a1","rhsgref_tla_rifleman_m1","rhsgref_tla_rifleman_M16","rhsgref_tla_rifleman_pm63","rhsgref_tla_rifleman_rpg75","rhsgref_tla_rifleman_vz58","rhsgref_tla_machinegunner","rhsgref_tla_machinegunner_mg42","rhsgref_tla_medic","O_G_Soldier_LAT2_F","O_G_Sharpshooter_F","O_G_officer_F","I_L_Criminal_SG_F","I_L_Hunter_F","I_L_Looter_Pistol_F","I_L_Looter_SG_F"];	
	_ArmPool=	["rhsgref_tla_btr60","rhsgref_BRDM2_ATGM_ins","rhsgref_BRDM2_ins"];
	_MotPool=	["rhsgref_tla_offroad_at","rhsgref_tla_offroad_at","rhsgref_tla_offroad_armed"];
	_ACHPool=	["RHS_Mi24V_vdv"];
	_CHPool=	["RHS_Mi8MTV3_vdv"];
	_uavPool=	[];
	_stPool=	["rhsgref_tla_DSHKM","rhsgref_tla_DSHKM_Mini_TriPod","rhsgref_tla_SPG9","rhsgref_tla_ZU23"];
	_shipPool=	["I_Boat_Armed_01_minigun_F","I_Boat_Transport_01_F"];
	_diverPool=	["rhsgref_tla_squadleader","rhsgref_tla_grenadier","rhsgref_tla_rifleman"];
